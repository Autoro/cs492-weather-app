...
import 'package:weatherapp/widgets/location/saved_location_edit_widget.dart';
import 'package:weatherapp/widgets/location/saved_location_widget.dart';
...
class SavedLocationsWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: _locations.map((loc) => _editMode
